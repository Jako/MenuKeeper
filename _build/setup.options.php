...
switch ($options[xPDOTransport::PACKAGE_ACTION]) {
    case xPDOTransport::ACTION_INSTALL:
        $output .= '<h2>Install MenuKeeper</h2>

        <p>Thanks for installing MenuKeeper. This open source extra was
    ...
    case xPDOTransport::ACTION_UPGRADE:
        $output .= '<h2>Upgrade MenuKeeper</h2>

        <p>MenuKeeper will be upgraded. This open source extra was developed by
